...
\title{基于TPM 2.0的协议设计与分析研究}% 论文中文题目
\author{王微谨}% 论文作者
\advisor{冯登国~研究员~中国科学院软件研究所}% 指导教师：姓名 专业技术职务 工作单位
...
%-> 英文封面信息
%-
\englishtitle{Design and Formal Analysis of \\ TPM 2.0 based Trusted Computing Protocols}% 论文英文题目
\englishauthor{Weijin Wang}% 论文作者
\englishadvisor{Supervisor: Professor Dengguo Feng}% 指导教师
...
\englishmajor{Technology of Computer Application
}% 二级学科专业名称
